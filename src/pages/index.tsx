  ...
  const router = useRouter();
    ...
    return (<Main meta={<Meta title="Bienvenido a Valencia Hike" description="Organización sin fines de lucro dedicada a mostrar las rutas de montaña que ofrece el estado Carabobo y Venezuela." />}>
        ...
        <section className="relative z-10 bg-cream-yellow py-20 lg:pb-40 lg:pt-24">
            ...
            <div className="container">
                <div className="text-center max-w-3xl mx-auto mb-12">
                    <h1 className="text-3xl lg:text-5xl font-title font-bold mb-4">Conoce <span className="text-primary-light">Nuestro Equipo</span></h1>
                    <div className="font-serif text-stone-500 mt-6">
                    ...
                    {team.map(person => (
                        <div className="group bg-white rounded-2xl text-center p-2 md:p-4">
                            <div className="relative mb-4">
                                ...
                                {/* rrss */}
                                {person.rrss ?
                                    <ul className='absolute left-0 -bottom-2 w-full flex items-center justify-center px-1 gap-1'>
                                        {person.rrss.instagram ?
                                            <li>
                                                <a href={`https://www.instagram.com/${person.rrss.instagram}`} className="inline-flex items-center justify-center rounded-full text-xs h-6 w-6 bg-primary-light text-white shadow-lg shadow-primary/25" title="Ver Instagram" target="_blank">
                                        ...
                                        {person.rrss.twitter ?
                                            <li>
                                                <a href={`https://www.twitter.com/${person.rrss.twitter}`} className="inline-flex items-center justify-center rounded-full text-xs h-6 w-6 bg-primary-light text-white shadow-lg shadow-primary/25" title="Ver Twitter" target="_blank">
                            ...
                            <div className="font-title mb-1 lg:mb-3 !leading-tight text-sm xl:text-base">{ person.name }</div>
