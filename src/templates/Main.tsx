                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-8 gap-x-4 lg:gap-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1">
                                ...
                                <li><Link href={`${router.basePath}/faqs`} className="hover:text-tertiary underline-offset-2 hover:underline">FAQs</Link></li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div className="col-span-2 sm:col-auto">
                            ...
                            <div className="flex flex-col items-start gap-y-3">
                                <a href="" className="inline-flex items-center gap-2 break-all hover:text-tertiary underline-offset-2 hover:underline">
                            ...
                            <ul className="flex items-center gap-2 mt-6">
                                <li>
                                    <a href={`https://www.instagram.com/${AppConfig.rrss.instagram}`} target="_blank" className="inline-flex items-center justify-center w-10 h-10 text-center bg-primary hover:bg-primary-light rounded-full shadow-md shadow-primary/50 transition-all hover:scale-105 hover:-translate-y-px">
                                ...
                                <li>
                                    <a href={`https://www.twitter.com/${AppConfig.rrss.twitter}`} target="_blank" className="inline-flex items-center justify-center w-10 h-10 text-center bg-primary hover:bg-primary-light rounded-full shadow-md shadow-primary/50 transition-all hover:scale-105 hover:-translate-y-px">
                                ...
                                <li>
                                    <a href={`whatsapp://send?phone=+${AppConfig.contact.whatsapp.formatted}&abid=+${AppConfig.contact.whatsapp.formatted}`} className="inline-flex items-center justify-center w-10 h-10 text-center bg-primary hover:bg-primary-light rounded-full shadow-md shadow-primary/50 transition-all hover:scale-105 hover:-translate-y-px">
