                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-8 gap-x-4 lg:gap-12">
                        ...
                        <div className="col-span-2 sm:col-auto">
                            ...
                            <ul className="flex items-center gap-2 mt-6">
                                ...
                                <li>
                                    <a href={`whatsapp://${AppConfig.contact.whatsapp.formatted}`} className="inline-flex items-center justify-center w-10 h-10 text-center bg-primary hover:bg-primary-light rounded-full shadow-md shadow-primary/50 transition-all hover:scale-105 hover:-translate-y-px">
