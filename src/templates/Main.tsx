            ...
            <footer className="relative bg-primary-dark font-serif text-white pt-20 lg:pt-24">
                <div className="container">
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-8 gap-x-4 lg:gap-8">
                        ...
                        <div>
                            <h6 className="inline-block text-primary-light uppercase pt-1 border-t-4 border-primary-light mb-4">Sobre nosotros</h6>
                        ...
                        <div>
                            <h6 className="inline-block text-primary-light uppercase pt-1 border-t-4 border-primary-light mb-4">Actividades</h6>
                            <ul className="space-y-1">
                        ...
                        <div className="col-span-2 sm:col-auto">
                            ...
                            <ul className="flex items-center gap-2 mt-6">
                                <li>
                                    <a href="" className="inline-flex items-center justify-center w-10 h-10 text-center bg-primary hover:bg-primary-light rounded-full shadow-md shadow-primary/50 transition-all hover:scale-105 hover:-translate-y-px">
                ...
                <div className="relative bg-white/10 text-center mt-20 pb-10 pt-20">
                    <div className="overflow-hidden">
                        <img src="http://valenciahike.test/home/img/decor/footer_mountain_primary_top.svg" alt="" className="absolute top-0 left-0 right-0 h-14 md:h-auto object-cover md:w-full select-none pointer-events-none" />
                    </div>
