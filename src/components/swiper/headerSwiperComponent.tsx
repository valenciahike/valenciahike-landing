                        ...
                        <div className="grid grid-cols-12 gap-8 items-center">
                            <div className="col-span-12 md:col-span-6 md:col-start-2">
                                ...
                                {/* <div className="flex items-center gap-4">
                                    <Link href="" target='_blank' className="inline-flex items-center gap-2 bg-secondary text-white hover:text-white/80 font-bold rounded-2xl bg-gradient-to-b from-secondary-light to-secondary-dark px-6 py-3 hover:-translate-y-px">
                                        Inscribirme
